...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <get_cow_faults+0xc>
  ...
  68:	44c50513          	addi	a0,a0,1100 # 4b0 <get_cow_faults+0x5c>
  ...
  8a:	3ea50513          	addi	a0,a0,1002 # 470 <get_cow_faults+0x1c>
  ...
  a4:	3e850513          	addi	a0,a0,1000 # 488 <get_cow_faults+0x34>
  ...
  e4:	3c050513          	addi	a0,a0,960 # 4a0 <get_cow_faults+0x4c>
...
0000000000000444 <get_fault_counts>:
...
000000000000044c <get_total_fault_counts>:
...
0000000000000454 <get_cow_faults>:
